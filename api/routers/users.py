...
def get_brands_listing(response: Response, accountType: Optional[str] = 'active', db: Session = Depends(get_db)):
    message, status_code, data = fetch_brands_listing(db=db, account_type=accountType)
